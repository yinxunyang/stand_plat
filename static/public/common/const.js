...
define({
    ...
    init: {
        // 是否开启DEBUG模式
        debug: false,
        // 支持tabs即默认布局，另外支持route即单页面布局（一般外网用）
        layout: 'tabs',
        // 是否支持市县集中模式
        multiArea: false,
        // 应用编码
    ...
    url: {
        ...
        authority: {
            ...
            transferRights: '@{portal}/api/authority/transferRights',
            transferCancel: '@{portal}/api/authority/transferCancel',
            roleRights: '@{portal}/api/authority/roleRights'
        },
        file: {
            upload: '${root}/api/file/upload',
            download: '${root}/api/file',      // /{fileId}
            view: '/api/file',
            thumb: '/api/thumb',
            del: 'DELETE:/api/file',
            updateShowName: 'PUT:/api/file/updateShowName',
            rotate: 'PUT:/api/file/rotate',
            crop: 'PUT:/api/file/crop'
        },
        excel: {
